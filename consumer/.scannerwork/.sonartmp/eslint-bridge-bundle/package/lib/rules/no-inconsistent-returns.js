    ...
    create(context) {
        ...
        function checkFunctionLikeDeclaration(node, functionContext) {
            ...
            if (hasInconsistentReturns(functionContext)) {
                ...
                const message = utils_1.toEncodedMessage(`Refactor this function to use "return" consistently.`, secondaryLocationsHolder, secondaryLocationMessages);
                context.report({
                    message,
...
function declaredReturnTypeContainsVoidTypes(returnTypeNode) {
