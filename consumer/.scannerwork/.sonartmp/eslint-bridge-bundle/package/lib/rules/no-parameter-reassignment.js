...
exports.rule = {
    create(context) {
        ...
        function raiseIssue(reference) {
            ...
            context.report(Object.assign({ message: `Introduce a new variable or use its initial value before reassigning "${reference.identifier.name}".` }, locationHolder));
        }
        function popContext() {
        ...
        return {
            ...
            onCodePathSegmentLoop(_fromSegment, _toSegment, node) {
                ...
                utils_1.resolveIdentifiers(parent.left, true)
